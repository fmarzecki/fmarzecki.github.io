...
![Desktop View](/assets/lib/ARP/a.png){: width="972" height="589" }
...
![ARP Spoofing - Network Topology](/assets/lib/ARP/ARP_1.drawio.png)
...
![Sending Forged ARP Message to SwitchB](/assets/lib/ARP/ARP2.drawio.png)
*Figure 2: Sending Forged ARP Message to SwitchB and Admin*

### Network Traffic Analysis:

![Wireshark - Attacker Executing the Attack](/assets/lib/ARP/wires.png)
...
![Infected Topology](/assets/lib/ARP/ARP3.drawio.png)
...
![Wireshark - Intercepted Traffic](/assets/lib/ARP/ss.png)
...
![Wireshark - Captured Telnet Password](/assets/lib/ARP/ss1.png)
...
![Adding Entry to Binding Table](/assets/lib/ARP/ARP5.drawio.png)
...
![DAI Process - ARP Frame Rejection](/assets/lib/ARP/ARP4.drawio.png)

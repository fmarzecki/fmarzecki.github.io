...
![Desktop View](/assets/lib/STP/git.png){: width="972" height="589" }
...
![STP Root Attack - Network Topology](/assets/lib/STP/STP_TOP.png)
...
![Sending Forged BPDU Frames to Switch](/assets/lib/STP/sending.drawio.png)
...
![Network Topology from Switch B's Perspective](/assets/lib/STP/final.drawio.png)
